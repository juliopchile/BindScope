...
**Next:** Product Depth track (PD1–PD7) in `PLAN.md`. **PD1 complete** — **26** curated catalog
entries (22 games + 4 tools). Default next: **PD2** (modifier combinations UI). Remaining: V2
