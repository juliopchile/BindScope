...
export const en = {
  ...
  emptySelection:
    'No games selected. Open Games & tools below and add a title — or a tool like OBS — to see free keys.',
  controlsToggle: 'Games & tools',
  controlsToggleHint: 'Search, layers, import / export',
  removeGame: 'Remove',
